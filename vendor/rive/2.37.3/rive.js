...
}, 566671:() => void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia, 566775:() => {
  try {
...
}, 569823:a => window.h.sa(a).K.sampleRate, 569896:a => {
  a = window.h.sa(a);
